...
| CF-3 | `/cancel` and CLI cancel are thread-wide; no exact-reference target | F3 | `gateway_commands#cancel_request`; `CommsStore#stamp_cancellation_requested!`; `CLISessionCommands` cancel | 1 | Verified; open |
