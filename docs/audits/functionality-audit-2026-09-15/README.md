...
The shared audit package now contains 36 JSON analyst records expanding to 47
row surfaces: all 27 gem responsibilities, the reference app and executable
surfaces, the aggregate script/Rakefile rows, and CF01–CF07. The current analyst
snapshot has 39 `IMPROVE` and 8 `PASS` verdicts. All rows now have a scalability
...
CF01–CF07 now have direct end-to-end reports; CF03, CF04, CF05, CF06, and CF07 carry
