...
The shared audit package now contains 34 JSON analyst records expanding to 45
row surfaces: all 27 gem responsibilities, the reference app and executable
surfaces, the aggregate script/Rakefile rows, and CF01–CF05. The current analyst
snapshot has 37 `IMPROVE` and 8 `PASS` verdicts. All rows now have a scalability
...
CF01–CF05 now have direct end-to-end reports; CF03, CF04, and CF05 carry existing
authority, reliability, and replay findings without double-counting them.
