# Clean-Code Quality Bar — agent gems refactor

This is the definition of done for the `tamoz-agent-capabilities`, `tamoz-agent-cli`, `tamoz-agent-healing`, and `tamoz-agent-improvement` refactor.
...
- [ ] Every `.rb` file in the four gems has been reviewed and, if needed, refactored.
