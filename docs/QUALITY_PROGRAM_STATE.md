...
- **Date:** 2026-08-06
- **HEAD:** `320658d` (main) — "Q3 checkpoint_store slice 2: row decoders" (next: materialize completion, in flight)
- **Tree:** clean
- **Branch:** main. Never push/tag/release/rewrite. (origin was externally updated to `a126fda` — local commits stay local.)
- **Quality commits so far:** 23 (`8ce5581` Q0 toolchain → `320658d` row decoders)
