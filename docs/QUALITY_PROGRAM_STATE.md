...
~~`Snapshot` (~43)~~ **DONE (35)** → ~~`Catalog` (~110)~~ **DONE (36)** →
~~`Walk` (~142)~~ **DONE (37)** → ~~`Frontmatter` (~179)~~ **DONE (38)** →
`Compiler` (~264). skills.rb 1,063 → **578** so far. Parent reek debt 111 → **52**,
concentrated in Compiler.
