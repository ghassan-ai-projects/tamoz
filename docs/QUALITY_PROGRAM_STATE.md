...
~~`Compiler` (~264)~~ **DONE (39).** skills.rb 1,063 → **311**. Parent reek debt
111 → **23**; all five nested responsibilities now live at their mapped paths.
