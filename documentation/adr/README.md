...
- **Add a new ADR:** copy [`_TEMPLATE.md`](./_TEMPLATE.md) to `adr-<NNN>-<slug>.md` (next
  number is at the bottom of the index), add one row here, and run `rake adr:validate
  adr:verify`. [`LIFECYCLE.md`](./LIFECYCLE.md) is the full workflow (authoring, revising,
  retiring); [`ADR_QUALITY_BAR.md`](./ADR_QUALITY_BAR.md) §4 is the acceptance rubric.
...
| [`_TEMPLATE.md`](./_TEMPLATE.md) | Copyable ADR skeleton — start a new decision here. |
| [`LIFECYCLE.md`](./LIFECYCLE.md) | The workflow: authoring, revising, retiring — with the rake commands. |
...
| [`relationships.md`](./relationships.md) | Mermaid graph of the supersession/amendment edges (`rake adr:graph`). |
