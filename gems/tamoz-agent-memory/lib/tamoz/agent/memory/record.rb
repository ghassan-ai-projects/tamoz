      ...
      class MemoryRecord < Data.define(
        ...
        def initialize(
          ...
          super(
            ...
            source_refs: Tamoz::Core.deep_freeze(validate_source_refs(source_refs)),
            owner: validate_id(owner, "owner"),
            actor: actor.nil? ? nil : validate_id(actor, "actor"),
            scopes: Tamoz::Core.deep_freeze(validate_scopes(scopes)),
            ...
            use_counts: Tamoz::Core.deep_freeze(validate_use_counts(use_counts)),
            created_by: Tamoz::Core.deep_freeze(created_by || {}),
