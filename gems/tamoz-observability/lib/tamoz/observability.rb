...
module Tamoz
  ...
  # value, and the Recorder contract every producer talks to. Depends only on
  # tamoz-core; the journal, exporters and reconstruction ship in later
  # slices, and signals must never change a committed byte.
